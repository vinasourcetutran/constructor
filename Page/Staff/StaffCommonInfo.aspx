<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Page.Master" AutoEventWireup="true"
    CodeBehind="StaffCommonInfo.aspx.cs" Inherits="RLM.Construction.WebApplication.Page.Staff.StaffCommonInfo1" %>
...
<div class="EditFormWrapper">
        ...
        <div class="BottonRow">
            <asp:Button ID='btnEdit' OnClick="btnEdit_OnClick" runat="server" meta:resourcekey="Edit" />
        </div>
        </div>
</asp:Content>
