<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Page.Master" AutoEventWireup="true" CodeBehind="StaffResponsibilityInfo.aspx.cs" Inherits="RLM.Construction.WebApplication.Page.Staff.StaffResponsibilityInfo" %>
...
<div>
    ...
    <fieldset>
        <legend id="legend" meta:resourcekey="ResponsibilityDetail" runat="server"></legend>
                ...
                <rlm:Repeater ID='rptItems' runat="server" OnItemDataBound="rptItems_OnItemDataBound">
                    <HeaderTemplate>
                        <table cellpadding="0" class="PreviewTableForm" cellspacing="0" border="0">
                            <tr>
                                 <th>
                                    <asp:Literal ID="ltrHTitle" runat="server" meta:resourceKey="Title"></asp:Literal>
                                </th>
                                 <th>
