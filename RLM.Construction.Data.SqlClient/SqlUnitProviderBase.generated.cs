...
namespace RLM.Construction.Data.SqlClient
{
	...
	///</summary>
	public partial class SqlUnitProviderBase : UnitProviderBase
	{
		#region Declarations
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<Unit> GetByToUnitIdFromUnitConvertor(TransactionManager transactionManager, System.Int32 toUnitId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Unit_GetByToUnitIdFromUnitConvertor", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@ToUnitId", DbType.Int32, toUnitId);
			
			IDataReader reader = null;
			//Create collection and fill
			RLM.Construction.Entities.TList<Unit> rows = new RLM.Construction.Entities.TList<Unit>();
		...
		/// <param name="count">out parameter to get total records for query</param>
		/// <returns>Returns a <c>TList</c> of Unit objects.</returns>
		public override TList<Unit> GetByFromUnitIdFromUnitConvertor(TransactionManager transactionManager, System.Int32 fromUnitId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Unit_GetByFromUnitIdFromUnitConvertor", _useStoredProcedure);
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 unitId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Unit_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@UnitId", DbType.Int32, unitId);
		...
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Unit objects.</returns>
		public override RLM.Construction.Entities.TList<Unit> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new RLM.Construction.Entities.TList<Unit>();
		...
		database.AddInParameter(commandWrapper, "@IsBaseUnit", DbType.Boolean, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LastModificationUserId", DbType.Int32, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("isbaseunit ") || clause.Trim().StartsWith("isbaseunit="))
				{
					database.SetParameterValue(commandWrapper, "@IsBaseUnit", 
						clause.Replace("isbaseunit","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Unit objects.</returns>
		public override RLM.Construction.Entities.TList<Unit> Find(TransactionManager transactionManager, SqlFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Unit_Find_Dynamic", typeof(UnitColumn), parameters, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.TList<Unit> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Unit objects.</returns>
		public override RLM.Construction.Entities.TList<Unit> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.Unit GetByUnitId(TransactionManager transactionManager, System.Int32 unitId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Unit_GetByUnitId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@UnitId", DbType.Int32, unitId);
			
			IDataReader reader = null;
			RLM.Construction.Entities.TList<Unit> tmp = new RLM.Construction.Entities.TList<Unit>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Unit object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<RLM.Construction.Entities.Unit> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("UnitId", typeof(System.Int32));
			...
			DataColumn col4 = dataTable.Columns.Add("IsDeletable", typeof(System.Boolean));
			col4.AllowDBNull = true;		
			DataColumn col5 = dataTable.Columns.Add("Priority", typeof(System.Int32));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("IsBaseUnit", typeof(System.Boolean));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("Type", typeof(System.Int32));
			...
			bulkCopy.ColumnMappings.Add("IsBaseUnit", "IsBaseUnit");
			...
			foreach(RLM.Construction.Entities.Unit entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["IsBaseUnit"] = entity.IsBaseUnit.HasValue ? (object) entity.IsBaseUnit  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a RLM.Construction.Entities.Unit object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Unit object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Unit object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, RLM.Construction.Entities.Unit entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Unit_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@UnitId", DbType.Int32, 4);
			...
			database.AddInParameter(commandWrapper, "@IsBaseUnit", DbType.Boolean, (entity.IsBaseUnit.HasValue ? (object) entity.IsBaseUnit  : System.DBNull.Value));
			...
			entity.UnitId = (System.Int32) database.GetParameterValue(commandWrapper, "@UnitId");						
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Unit object to update.</param>
		/// <remarks>
		///		After updating the datasource, the RLM.Construction.Entities.Unit object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, RLM.Construction.Entities.Unit entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
