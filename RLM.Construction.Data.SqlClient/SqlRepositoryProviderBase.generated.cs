...
/*
	...
	Important: Do not modify this file. Edit the file SqlRepositoryProvider.cs instead.
*/
...
namespace RLM.Construction.Data.SqlClient
{
	...
	///</summary>
	public partial class SqlRepositoryProviderBase : RepositoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlRepositoryProviderBase"/> instance.
		/// </summary>
		public SqlRepositoryProviderBase()
		{
		}
	...
	public SqlRepositoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<Repository> GetByItemIdFromItemInRepository(TransactionManager transactionManager, System.Int64 itemId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_GetByItemIdFromItemInRepository", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@ItemId", DbType.Int64, itemId);
			
			IDataReader reader = null;
			//Create collection and fill
			RLM.Construction.Entities.TList<Repository> rows = new RLM.Construction.Entities.TList<Repository>();
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 repositoryId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Repository)
					,repositoryId);
		...
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Repository objects.</returns>
		public override RLM.Construction.Entities.TList<Repository> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new RLM.Construction.Entities.TList<Repository>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@RepositoryManagerStaffId", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LastModificationUserId", DbType.Int32, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("repositorymanagerstaffid ") || clause.Trim().StartsWith("repositorymanagerstaffid="))
				{
					database.SetParameterValue(commandWrapper, "@RepositoryManagerStaffId", 
						clause.Replace("repositorymanagerstaffid","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Repository objects.</returns>
		public override RLM.Construction.Entities.TList<Repository> Find(TransactionManager transactionManager, SqlFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_Find_Dynamic", typeof(RepositoryColumn), parameters, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.TList<Repository> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Repository objects.</returns>
		public override RLM.Construction.Entities.TList<Repository> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.Repository GetByRepositoryId(TransactionManager transactionManager, System.Int32 repositoryId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_GetByRepositoryId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@RepositoryId", DbType.Int32, repositoryId);
			
			IDataReader reader = null;
			RLM.Construction.Entities.TList<Repository> tmp = new RLM.Construction.Entities.TList<Repository>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Repository object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<RLM.Construction.Entities.Repository> entities)
		{
			...
			bulkCopy.DestinationTableName = "Repository";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("RepositoryId", typeof(System.Int32));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("RepositoryManagerStaffId", typeof(System.Int32));
			...
			DataColumn col7 = dataTable.Columns.Add("Priority", typeof(System.Int32));
			...
			bulkCopy.ColumnMappings.Add("RepositoryManagerStaffId", "RepositoryManagerStaffId");
			...
			foreach(RLM.Construction.Entities.Repository entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["RepositoryManagerStaffId"] = entity.RepositoryManagerStaffId.HasValue ? (object) entity.RepositoryManagerStaffId  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a RLM.Construction.Entities.Repository object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Repository object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Repository object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, RLM.Construction.Entities.Repository entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@RepositoryId", DbType.Int32, 4);
			database.AddInParameter(commandWrapper, "@RepositoryManagerStaffId", DbType.Int32, (entity.RepositoryManagerStaffId.HasValue ? (object) entity.RepositoryManagerStaffId  : System.DBNull.Value));
			...
			entity.RepositoryId = (System.Int32) database.GetParameterValue(commandWrapper, "@RepositoryId");						
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Repository object to update.</param>
		/// <remarks>
		///		After updating the datasource, the RLM.Construction.Entities.Repository object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, RLM.Construction.Entities.Repository entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Repository_Update", _useStoredProcedure);
