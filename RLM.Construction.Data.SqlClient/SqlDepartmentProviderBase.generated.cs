...
namespace RLM.Construction.Data.SqlClient
{
	...
	///</summary>
	public partial class SqlDepartmentProviderBase : DepartmentProviderBase
	{
		#region Declarations
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 deptId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@DeptId", DbType.Int32, deptId);
		...
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Department objects.</returns>
		public override RLM.Construction.Entities.TList<Department> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new RLM.Construction.Entities.TList<Department>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@IsDeletable", DbType.Int64, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LastModificationUserId", DbType.Int32, DBNull.Value);
			...
			//Create Collection
			RLM.Construction.Entities.TList<Department> rows = new RLM.Construction.Entities.TList<Department>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Department objects.</returns>
		public override RLM.Construction.Entities.TList<Department> Find(TransactionManager transactionManager, SqlFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_Find_Dynamic", typeof(DepartmentColumn), parameters, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.TList<Department> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Department objects.</returns>
		public override RLM.Construction.Entities.TList<Department> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.Department GetByDeptId(TransactionManager transactionManager, System.Int32 deptId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_GetByDeptId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@DeptId", DbType.Int32, deptId);
			
			IDataReader reader = null;
			RLM.Construction.Entities.TList<Department> tmp = new RLM.Construction.Entities.TList<Department>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Department object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<RLM.Construction.Entities.Department> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("DeptId", typeof(System.Int32));
			...
			DataColumn col6 = dataTable.Columns.Add("IsActive", typeof(System.Int64));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("IsDeletable", typeof(System.Int64));
			...
			foreach(RLM.Construction.Entities.Department entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a RLM.Construction.Entities.Department object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Department object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Department object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, RLM.Construction.Entities.Department entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@DeptId", DbType.Int32, 4);
			...
			database.AddInParameter(commandWrapper, "@IsDeletable", DbType.Int64, (entity.IsDeletable.HasValue ? (object) entity.IsDeletable  : System.DBNull.Value));
			...
			entity.DeptId = (System.Int32) database.GetParameterValue(commandWrapper, "@DeptId");						
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Department object to update.</param>
		/// <remarks>
		///		After updating the datasource, the RLM.Construction.Entities.Department object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, RLM.Construction.Entities.Department entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Department_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@DeptId", DbType.Int32, entity.DeptId );
			database.AddInParameter(commandWrapper, "@Code", DbType.String, entity.Code );
			database.AddInParameter(commandWrapper, "@Name", DbType.String, entity.Name );
			database.AddInParameter(commandWrapper, "@Phone", DbType.AnsiString, entity.Phone );
			database.AddInParameter(commandWrapper, "@Priority", DbType.Int32, (entity.Priority.HasValue ? (object) entity.Priority : System.DBNull.Value) );
