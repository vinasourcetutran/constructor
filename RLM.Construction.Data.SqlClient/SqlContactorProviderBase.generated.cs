...
/*
	...
	Important: Do not modify this file. Edit the file SqlContactorProvider.cs instead.
*/
...
namespace RLM.Construction.Data.SqlClient
{
	...
	///</summary>
	public partial class SqlContactorProviderBase : ContactorProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlContactorProviderBase"/> instance.
		/// </summary>
		public SqlContactorProviderBase()
		{
		}
	...
	public SqlContactorProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 contactorId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@ContactorId", DbType.Int32, contactorId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Contactor)
					,contactorId);
		...
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Contactor objects.</returns>
		public override RLM.Construction.Entities.TList<Contactor> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new RLM.Construction.Entities.TList<Contactor>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Ext", DbType.AnsiString, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LastModificationUserId", DbType.Int32, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("jobtitle ") || clause.Trim().StartsWith("jobtitle="))
				{
					database.SetParameterValue(commandWrapper, "@JobTitle", 
						clause.Replace("jobtitle","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				if (clause.Trim().StartsWith("ext ") || clause.Trim().StartsWith("ext="))
				{
					database.SetParameterValue(commandWrapper, "@Ext", 
						clause.Replace("ext","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			RLM.Construction.Entities.TList<Contactor> rows = new RLM.Construction.Entities.TList<Contactor>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Contactor objects.</returns>
		public override RLM.Construction.Entities.TList<Contactor> Find(TransactionManager transactionManager, SqlFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_Find_Dynamic", typeof(ContactorColumn), parameters, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.TList<Contactor> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of RLM.Construction.Entities.Contactor objects.</returns>
		public override RLM.Construction.Entities.TList<Contactor> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RLM.Construction.Entities.Contactor GetByContactorId(TransactionManager transactionManager, System.Int32 contactorId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_GetByContactorId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@ContactorId", DbType.Int32, contactorId);
			
			IDataReader reader = null;
			RLM.Construction.Entities.TList<Contactor> tmp = new RLM.Construction.Entities.TList<Contactor>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Contactor object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<RLM.Construction.Entities.Contactor> entities)
		{
			...
			bulkCopy.DestinationTableName = "Contactor";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("ContactorId", typeof(System.Int32));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("PartnerId", typeof(System.Int32));
			col1.AllowDBNull = true;		
			DataColumn col2 = dataTable.Columns.Add("GroupId", typeof(System.Int32));
			...
			DataColumn col5 = dataTable.Columns.Add("JobTitle", typeof(System.String));
			...
			DataColumn col9 = dataTable.Columns.Add("Ext", typeof(System.String));
			...
			foreach(RLM.Construction.Entities.Contactor entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["ContactorId"] = entity.ContactorId;
		...
		/// <summary>
		/// 	Inserts a RLM.Construction.Entities.Contactor object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Contactor object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the RLM.Construction.Entities.Contactor object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, RLM.Construction.Entities.Contactor entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@ContactorId", DbType.Int32, 4);
			...
			entity.ContactorId = (System.Int32) database.GetParameterValue(commandWrapper, "@ContactorId");						
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">RLM.Construction.Entities.Contactor object to update.</param>
		/// <remarks>
		///		After updating the datasource, the RLM.Construction.Entities.Contactor object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, RLM.Construction.Entities.Contactor entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Contactor_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@ContactorId", DbType.Int32, entity.ContactorId );
			database.AddInParameter(commandWrapper, "@PartnerId", DbType.Int32, (entity.PartnerId.HasValue ? (object) entity.PartnerId : System.DBNull.Value) );
			database.AddInParameter(commandWrapper, "@GroupId", DbType.Int32, (entity.GroupId.HasValue ? (object) entity.GroupId : System.DBNull.Value) );
			database.AddInParameter(commandWrapper, "@Code", DbType.AnsiString, entity.Code );
			database.AddInParameter(commandWrapper, "@Name", DbType.String, entity.Name );
