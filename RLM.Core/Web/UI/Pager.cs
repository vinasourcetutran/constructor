    ...
    public class Pager : Label, INamingContainer
    {
        ...
        public string FirstButtonText
        {
            get
            {
                ...
                {
                    return Resource.Rex.Pager.PagerFirstButtonText;
                }
            ...
            set
            {
                ...
                {
                    this.ViewState["FirstButtonText"] = Resource.Rex.Pager.PagerFirstButtonText;
                }
                else
                {
        ...
        public string LastButtonText
        {
            get
            {
                ...
                {
                    return Resource.Rex.Pager.PagerLastButtonText;
                }
            ...
            set
            {
                if ((value == null) || (value.Length == 0))
                {
                    this.ViewState["LastButtonText"] = Resource.Rex.Pager.PagerLastButtonText;
                }
                else
                {
        ...
        public string NextButtonText
        {
            get
            {
                ...
                {
                    return Resource.Rex.Pager.PagerNextButtonText;
                }
            ...
            set
            {
                if ((value == null) || (value.Length == 0))
                {
                    this.ViewState["NextButtonText"] = Resource.Rex.Pager.PagerNextButtonText;
                }
                else
                {
        ...
        public string PreviousButtonText
        {
            get
            {
                ...
                {
                    return Resource.Rex.Pager.PagerPreviousButtonText;
                }
            ...
            set
            {
                if ((value == null) || (value.Length == 0))
                {
                    this.ViewState["PreviousButtonText"] = Resource.Rex.Pager.PagerPreviousButtonText;
                }
                else
                {
