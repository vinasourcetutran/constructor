<%@ Page Language="C#" MasterPageFile="~/MasterPage/Page.Master" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="RLM.Construction.WebApplication.Page.SystemSetting.RoleList" %>
...
<asp:content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:hyperlink ID='lnkAddNew' NavigateUrl="~/Page/Partner/RoleAddNew.aspx" CssClass="AddItem"
