...
(function($) {
    ...
    $.jcarousel = function(e, o) {
		...
		if((/MSIE 6\.0/).test(navigator.userAgent))
			this.buttonNext.hover(function(){
				$(this).addClass('hoverNextBtn');							   
			},function(){
				$(this).removeClass('hoverNextBtn');							   
			});
		...
		//From B.A
		if((/MSIE 6\.0/).test(navigator.userAgent))
			this.buttonPrev.hover(function(){
				$(this).addClass('hoverPrevBtn');							   
			},function(){
				$(this).removeClass('hoverPrevBtn');							   
			});
