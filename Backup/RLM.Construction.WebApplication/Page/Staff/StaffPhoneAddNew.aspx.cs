...
{
    public partial class StaffPhoneAddNew : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            {
                Save();
                Response.Redirect(UrlBuilderHelper.GetUrl(new ResourceData() { ResourceId = this.staffId }, NavigateAction.List, ResourceDataContentType.StaffPhone), true);
        ...
        private void Save()
        {
            ...
            if (this.item == null)
            {
                ...
                this.item.ContentType = (int)ResourceDataContentType.StaffPhone;
            ...
            xmlHash.Set(PhoneField.IsCurrentUsed.ToString(), Request.Params[chkIsUsedEmail.UniqueID] != null ? true : false);
            xmlHash.RootTag = ResourceDataContentType.StaffPhone.ToString();
        ...
        private void BindGuid()
        {
            ...
            try
            {
                chkIsUsedEmail.Checked = bool.Parse(xmlhash.GetKeyFromHash(PhoneField.IsCurrentUsed.ToString()));
            }
            catch (Exception) { }
