<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Page.Master" AutoEventWireup="true" CodeBehind="StaffPunishAddNew.aspx.cs" Inherits="RLM.Construction.WebApplication.Page.Staff.StaffPunishAddNew" %>
        ...
        <fieldset>
            ...
            <div class="EditFormWrapper">
                <div class="Row">
                    ...
                    <div>
                        <rlm:GroupComboBox ID='drpType' runat="server" Type="Punish" CssClass="AutoWidth"></rlm:GroupComboBox>
                    </div>
                </div>
                <div class="Row">
                    <label class="Label">
                ...
                <div class="Row">
                    <label class="Label">
                        <asp:Literal ID='Literal15' runat="server" meta:resourcekey="EffectTo"></asp:Literal>
                    </label>
                    <telerik:RadDatePicker ID="radEffectTo" runat="server" MinDate="1900-01-01">
                ...
                <div class="Row">
                    ...
                    <div>
                        <rlm:PunishFormTypeComboBox ID='drpForm' runat="server" CssClass="AutoWidth"></rlm:PunishFormTypeComboBox>
                    </div>
                </div>
                <div class="Row">
                    <label class="Label">
