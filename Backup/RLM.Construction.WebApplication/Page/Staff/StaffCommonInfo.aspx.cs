...
{
    public partial class StaffCommonInfo1 : System.Web.UI.Page
    {
        #region Variables
        ...
        {
            Response.Redirect(UrlBuilderHelper.GetUrl(new RLM.Construction.Entities.Staff() { StaffId = this.itemId }, NavigateAction.Edit), true);
        }
        #endregion
        ...
        private void BindGuid()
        {
            ...
            lblTempAddress.Text = string.Format("{0}, {1}", this.item.CurrentAddress, group != null ? group.Name : string.Empty);
