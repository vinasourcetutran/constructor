<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StaffIdentificationInfo.ascx.cs"
    Inherits="RLM.Construction.WebApplication.Page.Staff.StaffIdentification" %>
<div>
<a href='#' id='lnkAddNewItem' runat="server" class="AddItem" meta:resourcekey="AddNewItem"></a>
    <fieldset>
        <legend id="legend" meta:resourcekey="IdentifycationDetail" runat="server"></legend>
                    ...
                    <HeaderTemplate>
                        <table cellpadding="0" class="PreviewTableForm" cellspacing="0" border="0">
                            <tr>
                                ...
                                <th>
                                    <asp:Literal ID="Literal2" runat="server" meta:resourceKey="ID"></asp:Literal>
                                </th>
                              
                                <th>
                                    <asp:Literal ID="Literal4" runat="server" meta:resourceKey="IssuePlace"></asp:Literal>
                                </th>
                                <th>
                                    <asp:Literal ID="Literal5" runat="server" meta:resourceKey="IssueDate"></asp:Literal>
                                </th>
                                <th>
                                    <asp:Literal ID="Literal6" runat="server" meta:resourceKey="ExpiredDate"></asp:Literal>
                                </th>
                                 <th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                                <asp:Literal ID="ltrIssuePlace" runat="server"></asp:Literal>
                            </td>
                             <td>
                                <asp:Literal ID="ltrIssueDate" runat="server"></asp:Literal>
                            </td>
                             <td>
                                <asp:Literal ID="ltrExpiredDate" runat="server"></asp:Literal>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href='#' id='lnkEdit' runat="server" class="Edit"></a>
                                <a href='#' id='lnkDelete' visible="false" runat="server" class="Delete"></a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <NoneTemplate>
