<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Page.Master" AutoEventWireup="true" CodeBehind="StaffPhoneAddNew.aspx.cs" Inherits="RLM.Construction.WebApplication.Page.Staff.StaffPhoneAddNew" %>
        ...
        <fieldset>
            ...
            <div class="EditFormWrapper">
                <div class="Row">
                    ...
                    <div>
                        <rlm:PhoneTypeComboBox id='drpType' runat='server' />
                    </div>
                </div>
                <div class="Row">
                    <label class="Label">
                        <asp:Literal ID='Literal11' runat="server" meta:resourcekey="Phone"></asp:Literal>
