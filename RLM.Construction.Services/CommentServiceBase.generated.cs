...
{		
	...
	/// All custom implementations should be done in the <see cref="Comment"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class CommentServiceBase : ServiceBase<Comment, CommentKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="Comment"/> instance .
		///</summary>
		public CommentServiceBase() : base()
		{
		}
		...
		public static Comment CreateComment(System.String content, System.Int32 resourceType, System.Int32 resourceId, System.DateTime creationDate, System.Int32 creationUserId)
		{
			Comment newEntityComment = new Comment();
			newEntityComment.Content  = content;
			newEntityComment.ResourceType  = resourceType;
			newEntityComment.ResourceId  = resourceId;
			newEntityComment.CreationDate  = creationDate;
			newEntityComment.CreationUserId  = creationUserId;
			return newEntityComment;
		}
		#endregion Constructors

		#region Fields
		private static SecurityContext<Comment> securityContext = new SecurityContext<Comment>();
		...
		///</summary>
		public static SecurityContext<Comment> SecurityContext
		{
			get
			{
		...
		public override Comment Get(CommentKey key)
		{
			return GetByCommentId(key.CommentId);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Comment}" /> from the datasource based on the primary key PK_Comment index.
		/// </summary>
		/// <param name="commentId"></param>
		/// <returns>Returns an instance of the <see cref="Comment"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Comment GetByCommentId(System.Int32 commentId)
		{
			int totalCount = -1;
			return GetByCommentId(commentId, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns an instance of the <see cref="Comment"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Comment GetByCommentId(System.Int32 commentId, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByCommentId");
			totalCount = -1;
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.CommentProvider.GetByCommentId(transactionManager, commentId, start, pageLength, out totalCount)   as Comment;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="Comment" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<Comment> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="Comment" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{Comment}"/> </returns>
		public virtual TList<Comment> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<Comment> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.CommentProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{Comment}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Comment</c> objects.</returns>
		public virtual TList<Comment> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Comment</c> objects.</returns>
		public virtual TList<Comment> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{Comment}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Comment</c> objects.</returns>
		public override TList<Comment> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.CommentProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<Comment> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<Comment> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.CommentProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>Comment</c> objects.</returns>
		public virtual TList<Comment> Find(SqlFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Comment</c> objects.</returns>
		public virtual TList<Comment> Find(SqlFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>Comment</c> objects.</returns>
		public virtual TList<Comment> Find(SqlFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.CommentProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(Comment entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.CommentProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{Comment}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Comment</c> objects in a <see cref="TList{Comment}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<Comment> Insert(TList<Comment> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Comment>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.CommentProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(Comment entity)
		{
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.CommentProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{Comment}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Comment</c> objects in a <see cref="TList{Comment}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Comment> Update(TList<Comment> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Comment>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.CommentProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual Comment Save(Comment entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.CommentProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{Comment}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Comment</c> objects in a <see cref="TList{Comment}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Comment> Save(TList<Comment> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Comment>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.CommentProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(Comment entity)
		{
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.CommentProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{Comment}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Comment</c> objects in a <see cref="TList{Comment}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<Comment> Delete(TList<Comment> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Comment>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.CommentProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(CommentKey key)
		{
			return Delete(key.CommentId );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int32 commentId)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.CommentProvider.Delete(transactionManager, commentId);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="Comment"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="Comment"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Comment DeepLoadByCommentId(System.Int32 commentId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByCommentId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Comment entity = GetByCommentId(commentId);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(Comment)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Comment entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Comment entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="Comment"/> object to load.</param>
		...
		/// <param name="childTypes">Comment Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Comment entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.CommentProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{Comment}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Comment)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{Comment}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Comment> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{Comment}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Comment)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Comment> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{Comment}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{Comment}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="Comment"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<Comment> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.CommentProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="Comment"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">Comment Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(Comment entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Comment entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.CommentProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{Comment}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{Comment} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<Comment> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{Comment}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{Comment}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">Comment Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<Comment> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.CommentProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
